...
from matval_pipeline.config import PipelineConfig

def test_from_env_defaults(monkeypatch: MonkeyPatch) -> None:
...
def test_from_env_reads_env_vars(monkeypatch: MonkeyPatch) -> None:
    ...
    assert cfg.password == "grocery_password"