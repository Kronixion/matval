...
--- Improvement: Multiple supermarket chains, have multiple store locations with possibly different products.
--- Currently only the products from the biggest stores of those supermarkets is being taken.
...
CREATE TABLE IF NOT EXISTS store_products (
    ...
    supermarket_id                BIGINT NOT NULL
        REFERENCES stores (supermarket_id)
        ON UPDATE CASCADE
        ON DELETE CASCADE,
