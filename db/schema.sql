...
CREATE TABLE IF NOT EXISTS supermarkets (
    supermarket_id    BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    name        TEXT NOT NULL UNIQUE,
    created_at  TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    updated_at  TIMESTAMPTZ NOT NULL DEFAULT NOW()
);

--- Improvement: Multiple supermarket chains, have multiple store locations with possibly different products/prices.
--- Currently products from big/biggest stores are being retrieved.


--- categories and sub-categories for products are being inserted into one table (I should potentially split this)
--- but this method would allow for unlimited levels of depth.
